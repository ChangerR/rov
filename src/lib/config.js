...
var CpoytoEmmcPath = './lib/CopytoEmmc'
...
module.exports = {
  ...
  video_frame_rate: process.env.VIDEO_FRAME_RATE && parseInt(process.env.VIDEO_FRAME_RATE) || 30,
  ...
  CopytoEmmc:getLibPath(CpoytoEmmcPath)
};

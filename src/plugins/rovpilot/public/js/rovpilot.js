(function (window, $, undefined) {
	...
	$("#footercontent").prepend(
			...
			<h6>推进&nbsp;动力</h6><div class="label badge" id="thrustfactor">&nbsp;</div> \
		    </div>');
	$('#keyboardInstructions').append('<p>按 <i>i</i>开关灯</p>');
	$('#keyboardInstructions').append('<p>按 <i>[</i>开启ESC</p>');
    $('#keyboardInstructions').append('<p>按 <i>]</i>关闭ESC</p>');
    $('#keyboardInstructions').append('<p>按 <i>m</i> to toggle heading hold (BETA)</p>');
    $('#keyboardInstructions').append('<p>按 <i>n</i> to toggle depth hold (BETA)</p>');

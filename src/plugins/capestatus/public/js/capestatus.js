(function (window, $, undefined) {
	...
	this.lastPing = null;
	  ...
	  '   <div class="span1 pull-left"><h6>链接状态</h6><div id="connectionHealth">&nbsp;</div></div> \
	      <div class="span2 hidden pull-right"><h6>温度</h6><h2 data-bind="html: convertedTemperature"></h2></div> \
              <div class="span2 hidden pull-right"><div class="pull-right" id="depth-gauge"></div><h6>深度:</h6><h2 data-bind="text: convertedDepth"></h2></div> \
                <div class="span2 pull-right"><h2 id="formattedRunTime">时间</h2><h4 id="localtime">&nbsp;</h4></div> \
